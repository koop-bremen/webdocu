...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        ...
        return {
            ...
            places: [{ id: 1, name: 'Bremen', longitude: 54.12, latitude: 8.9 }, { id: 2, name: 'Bremen', longitude: 54.12, latitude: 8.9 }, { id: 3, name: 'Bremen', longitude: 54.12, latitude: 8.9 }, { id: 4, name: 'Bremen', longitude: 54.12, latitude: 8.9 }, { id: 5, name: 'Bremen', longitude: 54.12, latitude: 8.9 }, { id: 6, name: 'Bremen', longitude: 54.12, latitude: 8.9 }]
    ...
    methods: {
        ...
        getPlaces: function getPlaces() {
            return axios.get('api/places').then(function (places) {
                return _this.places = places.data;
            });
        }
          ...
          _c(
            ...
            _vm._l(_vm.places, function(place) {
              return _c("tr", [
                ...
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(place.longitude))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(place.latitude))])
              ])
            })
          )
        ])
...
var app = new Vue({
  ...
  routes: __WEBPACK_IMPORTED_MODULE_1__routes__["default"]
...
__webpack_require__("./resources/assets/js/routes.js");
